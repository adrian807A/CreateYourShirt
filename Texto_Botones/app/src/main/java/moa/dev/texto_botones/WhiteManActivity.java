...
public class WhiteManActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_white_man);
    }
    ...
    public void BlueMan(View view) {
        Intent blueman = new Intent(this, BlueMan.class);
        startActivity(blueman);
